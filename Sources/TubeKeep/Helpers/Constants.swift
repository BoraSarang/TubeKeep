...
enum Constants {
    ...
    static let playerToggleQueueNotification = Notification.Name("com.tubekeep.playerToggleQueue")
    static let playerToggleSubtitlePanelNotification = Notification.Name("com.tubekeep.playerToggleSubtitlePanel")
    static let playerToggleSimilarVideosNotification = Notification.Name("com.tubekeep.playerToggleSimilarVideos")
