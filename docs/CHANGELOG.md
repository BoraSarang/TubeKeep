...
## v3.12 — Hallmark 디자인 스킬 도입 + 랜딩 리디자인 + 디자인 원칙 반영 (macOS, T-1120~T-1126) ✅
...
### 검증 (T-1123)
- 로컬 HTTP + chrome-devtools: 1440/1280/768/375/320px 응답 — 비디오·AI 그리드 3열(데스크톱) → 2열(768) → 1열(375 이하), CTA 2열→1열, 수평 오버플로 0
